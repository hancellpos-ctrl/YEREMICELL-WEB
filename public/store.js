...
function closeProduct(update=true){if(orderDialog.open)orderDialog.close();if(photoViewer.open)photoViewer.close();dialog.close();currentProduct=null;document.body.style.overflow='';document.title='YEREMICELL · Catálogo de teléfonos';if(update&&location.pathname.startsWith('/producto/'))history.replaceState({},'',previousPath);lastFocus?.focus()}
